...
- Now automatically converts `https://api.carecompapp.com` to `wss://api-hrms-backend.kyptronix.us`
...
- **Fix:** Check if backend is running and accessible from `https://api.carecompapp.com`
