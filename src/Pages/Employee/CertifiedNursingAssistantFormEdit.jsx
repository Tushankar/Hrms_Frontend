...
const CertifiedNursingAssistantFormEdit = () => {
  ...
  const fetchTemplate = async () => {
    try {
      const response = await axios.get(
        `${baseURL}/onboarding/get-cna-job-description-template`,
    ...
    try {
      ...
      if (user?._id) {
        ...
        if (applicationId) {
          ...
          const response = await axios.get(
            `${baseURL}/onboarding/job-description/${applicationId}/CNA`,
            { withCredentials: true }
          );
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${baseURL}/onboarding/employee-upload-signed-cna-job-description`,
        formData,
        {
      ...
      if (response.data) {
        ...
        setFile(null);
        setSubmission(response.data.cnaJobDescription.employeeUploadedForm);

        setTimeout(() => {
          navigate("/employee/job-description-lpn");
        }, 1500);
      }
    } catch (error) {
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">
              CNA Job Description (Exhibit 1b)
            </h1>
            ...
            <div className="space-y-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row gap-4 sm:justify-between sm:items-center">
                  <button
                    type="button"
                    onClick={() => navigate("/employee/background-check")}
...
export default CertifiedNursingAssistantFormEdit;
