  ...
  const fetchTemplate = async () => {
    try {
      const response = await axios.get(
        `${baseURL}/onboarding/get-rn-job-description-template`,
    ...
    try {
      ...
      if (user?._id) {
        ...
        if (applicationId) {
          ...
          const response = await axios.get(
            `${baseURL}/onboarding/job-description/${applicationId}/RN`,
            { withCredentials: true }
          );
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${baseURL}/onboarding/employee-upload-signed-rn-job-description`,
        formData,
        {
      ...
      if (response.data) {
        ...
        setFile(null);
        setSubmission(response.data.rnJobDescription.employeeUploadedForm);
        setTimeout(() => {
            ...
            <div className="space-y-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row gap-4 sm:justify-between sm:items-center">
                  <button
                    type="button"
                    onClick={() => navigate("/employee/job-description-lpn")}
...
export default RegisteredNurseFormEdit;
