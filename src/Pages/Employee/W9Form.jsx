    ...
    <div className="bg-white p-6 sm:p-10 rounded-lg shadow-lg max-w-6xl w-full font-serif mx-auto">
      ...
      <div className="flex justify-between items-start pb-2">
        <div>
          ...
          <h1 className="text-base font-bold">Form W-9 <span className="font-normal">(Rev. 3-2024)</span></h1>
        </div>
      ...
      <div className="text-sm text-gray-900 leading-relaxed grid grid-cols-1 md:grid-cols-2 md:gap-x-8">
        ...
        <div>
          ...
          <ul className="list-disc pl-8 mb-4 space-y-1">
            <li><span className="font-bold">Form 1099-INT</span> (interest earned or paid).</li>
            <li><span className="font-bold">Form 1099-DIV</span> (dividends, including those from stocks or mutual funds).</li>
            <li><span className="font-bold">Form 1099-MISC</span> (various types of income, prizes, awards, or gross proceeds).</li>
            <li><span className="font-bold">Form 1099-NEC</span> (nonemployee compensation).</li>
            <li><span className="font-bold">Form 1099-B</span> (stock or mutual fund sales and certain other transactions by brokers).</li>
            <li><span className="font-bold">Form 1099-S</span> (proceeds from real estate transactions).</li>
            <li><span className="font-bold">Form 1099-K</span> (merchant card and third-party network transactions).</li>
            <li><span className="font-bold">Form 1098</span> (home mortgage interest), <span className="font-bold">1098-E</span> (student loan interest), and <span className="font-bold">1098-T</span> (tuition).</li>
            <li><span className="font-bold">Form 1099-C</span> (canceled debt).</li>
            <li><span className="font-bold">Form 1099-A</span> (acquisition or abandonment of secured property).</li>
          </ul>
          <p className="mb-4">
          ...
          <div className="p-3 mb-4">
            <p>
              <span className="font-bold">Caution:</span> If you don't return Form W-9 to the requester with a TIN, you
              might be subject to backup withholding. See <span className="italic">What is backup
              withholding</span>, later.
            </p>
          </div>
          <p className="mb-4">
            <span className="font-bold">By signing the filled-out form, you:</span>
          </p>
          {/* Numbered List */}
          <ol className="list-decimal pl-8 mb-4 space-y-1">
            ...
            <li>Certify that FATCA code(s) entered on this form (if any) indicating that you are exempt from the FATCA reporting is correct. See <span className="italic">What Is FATCA Reporting</span>, later, for further information.</li>
          </ol>
          <p className="mb-4">
          ...
          <h2 className="text-sm font-bold mb-2">Definition of a U.S. person.</h2>
          <p className="mb-4">
          ...
          {/* Adjusted heading size */}
          <h2 className="text-sm font-bold mb-2">Establishing U.S. status for purposes of chapter 3 and chapter 4 withholding.</h2>
          <p className="mb-4">
            ...
            recipient, owner, transferor, or partner (payee). See <span className="italic">Pub. 515,
            Withholding of Tax on Nonresident Aliens and Foreign Entities.</span>
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4 mt-2">
            See <span className="italic">Pub. 515</span> for more information on providing a Form W-9 or a
        ...
        <div>
          ...
          <p className="mb-4">
            ...
            appropriate Form W-8 or Form 8233 (see <span className="italic">Pub. 515</span>). If you are a
            qualified foreign pension fund under Regulations section 1.897(1)-1(d), or
          ...
          {/* Adjusted heading size */}
          <h2 className="text-sm font-bold mb-2">Nonresident alien who becomes a resident alien.</h2>
          <p className="mb-4">
            Generally, only a
          ...
          <p className="mb-4">
            <span className="font-bold">Example.</span> Article 20 of the U.S.-China income tax treaty allows an
          ...
          <div>
            ...
            {/* Adjusted heading size */}
            <h3 className="text-sm font-bold mb-2">What is backup withholding?</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              <span className="font-bold">Payments you receive will be subject to backup withholding if:</span>
            </p>
            <ol className="list-decimal pl-8 mb-4 space-y-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6">
        ...
        <div className="text-xs leading-normal">
          ...
          <p className="mb-1.5">
            ...
            See <em className="italic">Exempt payee code</em> later and the separate Instructions for the
            Requestor of Form W-9 for more information.
          </p>
          <p className="mb-4">
            See also <em className="italic">Establishing U.S. status for purposes of chapter 3 and
            chapter 4 withholding</em>, earlier.
          </p>
          <section className="mb-3">
            {/* Headings smaller */}
            <h2 className="text-base font-bold mb-1">What Is FATCA Reporting?</h2>
            <p className="mb-1.5">
              ...
              FATCA reporting. See <em className="italic">Exemption from FATCA reporting code</em> later in the
              instructions and the Instructions for the Requestor of Form W-9 for more
              information.
            </p>
          </section>
          <section className="mb-3">
            <h2 className="text-base font-bold mb-1">Updating Your Information</h2>
            <p className="mb-1.5">
              You must provide updated information to any person to whom you
              are claiming to be an exempt payee if you are no longer an exempt
              payee and anticipate receiving reportable payments in the future from
              this person. For example, you may need to provide updated information
              if you are a C corporation that elects to be an S corporation, or if you are
          ...
          <section className="mb-3">
            ...
            <p className="mb-1.5">
              <strong className="font-bold">Failure to furnish TIN.</strong> If you fail to furnish your correct TIN to a
              requestor, you are subject to a penalty of $50 for each such failure
              unless your failure is due to reasonable cause and not to willful neglect.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">Civil penalty for false information with respect to withholding.</strong> If you
              make a false statement with no reasonable basis that results in no
              backup withholding, you are subject to a $500 penalty.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">Criminal penalty for falsifying information.</strong> Willfully falsifying
              certifications or affirmations may subject you to criminal penalties
              including fines and/or imprisonment.
            </p>
            <p>
              <strong className="font-bold">Misuse of TINs.</strong> If the requestor discloses or uses TINs in violation of
          ...
          <section className="mb-3">
            ...
            <p className="mb-1.5">
              You must enter one of the following on this line; <strong className="font-bold">do not</strong> leave this line
            ...
            <p className="mb-1.5">
              <strong className="font-bold">a. Individual.</strong> Generally, enter the name shown on your tax return. If you
              have changed your last name without informing the Social Security
              Administration (SSA) of the name change, enter your first name, the last
              name as shown on your social security card, and your new last name.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">Note for ITIN applicant:</strong> Enter your individual name as it was entered
              on your Form W-7 application, line 1a. This should also be the same as
              the name you entered on the Form 1040/1040-SR/1040-NR you filed
              with your application.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">b. Sole proprietor.</strong> Enter your individual name as shown on your
              Form 1040/1040-SR/1040-NR on line 1. Enter your business, trade, or
              “doing business as” (DBA) name on line 2.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">c. Partnership, C corporation, S corporation, or LLC, other than a
              disregarded entity.</strong> Enter the entity's name as shown on the entity's tax
              return on line 1 and any business, trade, or DBA name on line 2.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">d. Other entities.</strong> Enter your name as shown on required U.S. federal
            ...
            <p className="mb-1.5">
              <strong className="font-bold">e. Disregarded entity.</strong> In general, a business entity that has a single
        ...
        <div className="text-xs leading-normal">
                ...
                <div className="w-1/2 p-1 border-r-2 border-black">
                  <ul className="list-disc list-outside pl-4">
                    <li>LLC that has filed Form 8832 or
                      2553 (or is electing to be taxed as a
                      corporation)</li>
                  </ul>
                </div>
                <div className="w-1/2 p-1">
          ...
          <section className="mb-3">
            ...
            <p className="mb-1.5">
              ...
              partnership for U.S. federal tax purposes), trust, or estate that has
              foreign partners, owners, or beneficiaries, and you are providing this
              Form W-9 to document a U.S. partner's, owner's or beneficiary's
              interest. You must check the box on line 3b if you receive a Form W-8
              ben (or other W-8 series form) or Form W-9 from any partner,
              beneficiary or owner establishing foreign status or if you receive a Form
              W-9 from any partner, owner, or beneficiary that has checked the box on
              line 3b.
            </p>
            <p className="mb-1.5">
              <strong className="font-bold">Note:</strong> A partnership that provides a Form W-9 check box on 3b may
            ...
            <p className="mb-1.5">
              ...
              rely on the Form W-9 to treat a U.S. partner, owner, or beneficiary as
              exempt from the IRS or furnish a correct payee statement to your
              partners or beneficiaries. See, for example, sections 6698, 6722, and
              6724 for penalties that may apply.
            </p>
          </section>
          <section className="mb-3">
            ...
            <ul className="list-disc list-outside pl-4 space-y-1">
              ...
              <li>
                ...
                respect to payments reportable on Form 1099-MISC.
              </li>
            </ul>
            ...
            <p className="mt-1.5">
              <strong className="font-bold">1</strong> - An organization exempt from tax under section 501(a), any IRA, or
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto bg-white p-6 md:p-10 shadow-lg border border-gray-300 font-serif text-black">
      ...
      <header className="flex justify-between items-center border-b border-black pb-2 mb-4">
        <h1 className="font-bold text-sm">Form W-9 <span className="font-normal">(Rev. 3-2024)</span></h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-4">
          ...
          <div className="space-y-4">
            ...
            <ol start="2" className="list-decimal list-outside pl-5 space-y-1">
              ...
              <li>A state, the District of Columbia, a U.S. commonwealth or territory, or any of their political subdivisions or instrumentalities.</li>
              <li>A foreign government or any of its political subdivisions, agencies, or instrumentalities.</li>
              <li>A corporation.</li>
              <li>A dealer in securities or commodities required to register in the United States, the District of Columbia, or a U.S. commonwealth or territory.</li>
            ...
            <table className="w-full my-4 border-collapse border border-black table-fixed text-[11px] leading-normal">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="border border-black p-2 text-left font-bold align-top w-1/2">If the payment is for . . .</th>
                  <th className="border border-black p-2 text-left font-bold align-top w-1/2">THEN the payment is exempt for . . .</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className="border border-black p-2 align-top">
                    <ul className="list-disc list-outside pl-5">
                      <li>Barter exchange transactions and patronage dividends</li>
                    </ul>
                  </td>
                  <td className="border border-black p-2 align-top">
                ...
                <tr>
                  <td className="border border-black p-2 align-top">
                    <ul className="list-disc list-outside pl-5">
                      <li>Payments over $600 required to be reported and direct sales over $5,000¹</li>
                    </ul>
                  </td>
                  <td className="border border-black p-2 align-top">
                ...
                <tr>
                  <td className="border border-black p-2 align-top">
                    <ul className="list-disc list-outside pl-5">
                      <li>Payments made in settlement of payment card or third-party network transactions</li>
                    </ul>
                  </td>
                  <td className="border border-black p-2 align-top">
                    Exempt payees 1 through 4.
            ...
            <div className="space-y-2">
              <p>¹See Form 1099-MISC, Miscellaneous Information, and its instructions.</p>
              ...
              <p>
                <strong className="font-bold">Exemption from FATCA reporting code.</strong> The following codenamed payees are exempt from reporting under FATCA. These codes apply to persons submitting this form for accounts maintained outside of the United States by certain foreign financial institutions. Therefore, if you are only submitting this form for an account you hold in the UnitedStates, you may leave this field blank. Consult with the person requesting this form if you are uncertain if the financial institution is subject to these requirements. A requester may indicate that a code is not required by providing you with a Form W-9 with "Not Applicable" (or any similar indication) written or typed on the line for a FATCA exemption code.
              </p>
              <ul className="list-none space-y-1 pl-4">
                ...
                <li>C—A state, the District of Columbia, a U.S. commonwealth or territory, or any of their political subdivisions or instrumentalities.</li>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-none space-y-1">
              <li>F—A dealer in securities, commodities, or derivative financial instruments (including notional principal contracts, futures, forwards, and options) registered as such under the laws of the United States or any state.</li>
              <li>G—A real estate investment trust.</li>
              <li>H—An entity registered at all times during the tax year under the Investment Company Act of 1940.</li>
              <li>I—A common trust fund as defined in section 584(a).</li>
              <li>J—A bank as defined in section 581.</li>
              <li>K—A broker.</li>
              <li>L—A trust exempt from tax under section 664(c) or described in section 4947(a)(1).</li>
              <li>M—A tax-exempt trust under a section 403(b) plan or section 457(g) plan.</li>
              <li className="mt-2">
                <strong className="font-bold">Note:</strong> You may wish to consult with the financial institution requesting this form to determine whether the FATCA code and/or exempt payee code should be completed.
              </li>
            </ul>
            {/* Line 5 */}
            <div>
              <strong className="font-bold block text-sm mb-1">Line 5</strong>
              <p>Enter your address (number, street, and apartment or suite number). This is where the requester of this Form W-9 will mail your information returns. If this address differs from the one the requester already has on file, write "NEW" at the top. If a new address is provided, there isn't a chance the old address will be used until the payor changes your address in their records.</p>
            </div>
            {/* Line 6 */}
            <div>
            ...
            <div className="space-y-2">
              <strong className="font-bold block text-sm mb-1">Part I. Taxpayer Identification Number (TIN)</strong>
              {/* All paragraphs are now siblings. pl-4 is added to all except the first for indentation. */}
              <p>
                Enter your TIN in the appropriate box. If you are a resident alien and you do not have and are not eligible to get an SSN, your TIN is your IRS ITIN. Enter it in the entry space for the social security number. If you do not have an ITIN, see <em className="italic">How to get a TIN</em> below.
              </p>
              <p className="pl-4">
              ...
              <p className="pl-4">
                <strong className="font-bold">Note:</strong> See <em className="italic">What Name and Number To Give the Requester</em>, later, for further clarification of name and TIN combinations.
              </p>
              <p className="pl-4">
                <strong className="font-bold">How to get a TIN.</strong> If you do not have a TIN, apply for one immediately. To apply for an SSN, get Form SS-5, Application for a Social Security Card, from your local SSA office or get this form online at <em className="italic">www.SSA.gov</em>. You may also get this form by calling 800-772-1213. Use Form W-7, Application for IRS Individual Taxpayer Identification Number, to apply for an ITIN, or Form SS-4, Application for Employer Identification Number, to apply for an EIN. You can apply for an EIN online by accessing the IRS website at <em className="italic">www.irs.gov/EIN</em>. Go to <em className="italic">www.irs.gov/Forms</em> to view, download, or print Form W-7 and/or Form SS-4. Or, you can go to <em className="italic">www.irs.gov/OrderForms</em> to place an order and have Form W-7 and/or Form SS-4 mailed to you within 15 business days.
              </p>
              <p className="pl-4">
                If you are asked to complete Form W-9 but do not have a TIN, apply for one in the space for the TIN, write "Applied For," sign and date the form, and give it to the requester. For interest and dividend payments, and certain payments made with respect to readily tradable instruments, you will generally have 60 days to get a TIN and give it to the requester before you are subject to backup withholding on payments. The 60-day rule does not apply to other types of payments. You will be subject to backup withholding on all such payments until you provide your TIN to the requester.
              </p>
              <p className="pl-4">
                {/* Fixed typo: font-Dold -> font-bold */}
                <strong className="font-bold">Note:</strong> Entering "Applied For" means that you have already applied for a TIN or that you intend to apply for one soon. See also <em className="italic">Establishing U.S. status for purposes of chapter 3 and chapter 4 withholding</em>, earlier, for when you may instead be subject to withholding under chapter 3 or 4 of the Code.
              </p>
              <p className="pl-4">
                <strong className="font-bold">Caution:</strong> A disregarded U.S. entity that has a foreign owner must use the appropriate Form W-8.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                withholding agent even if item 1, 4, or 5 below indicates a change.
              </p>
              <p>
                For a joint account, only the person whose TIN is shown in Part I
                should sign (when required). If you are a disregarded entity, the
                person identified on line 1 must sign. Exempt payees, see <em className="italic">Exempt payee
                code</em>, earlier.
              </p>
              <p>
                <strong className="font-bold">Signature requirements.</strong> Complete the certification as indicated in
            ...
            <ol className="list-decimal list-outside pl-5 space-y-2">
              <li>
                <strong className="font-bold">Interest, dividend, and barter exchange accounts opened
                before 1984 and broker accounts considered active during 1983.</strong>
                You must give your correct TIN, but you do not have to sign the
                certification.
              </li>
              <li>
                <strong className="font-bold">Interest, dividend, broker, and barter exchange accounts
                opened after 1983 and broker accounts considered inactive
                during 1983.</strong> You must sign the certification or backup withholding will apply. If
                you are subject to backup withholding and you are merely providing
                your correct TIN to the requester, you must cross out item 2 in the
                certification before signing the form.
              </li>
              <li>
                <strong className="font-bold">Real estate transactions.</strong> You must sign the certification. You
                may cross out item 2 of the certification.
              </li>
              <li>
                <strong className="font-bold">Other payments.</strong> You must give your correct TIN, but you do not
                ...
                card or third party network transactions, payments to certain fishing
                boat crew members and fishermen, and gross proceeds paid to
                attorneys (including payments to corporations).
              </li>
              <li>
                <strong className="font-bold">Mortgage interest paid by you, acquisition or abandonment
                ...
                contributions or distributions, and pension distributions.</strong> You
            ...
            <div className="space-y-2">
              <h2 className="text-sm font-bold mt-2">What Name and Number To Give the Requester</h2>
             
              <table className="w-full my-2 border-collapse border border-black table-fixed text-[11px] leading-normal">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="border border-black p-2 text-left font-bold align-top w-1/2">For this type of account:</th>
                    <th className="border border-black p-2 text-left font-bold align-top w-1/2">Give name and SSN of:</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-black p-2 align-top">1. Individual</td>
                    <td className="border border-black p-2 align-top">The individual</td>
                  </tr>
                  <tr>
                    <td className="border border-black p-2 align-top">2. Two or more individuals (joint account) other than an account maintained by an FFI</td>
                    <td className="border border-black p-2 align-top">The actual owner of the account or, if combined funds, the first individual on the account</td>
                  </tr>
                  <tr>
                    <td className="border border-black p-2 align-top">3. Two or more U.S. persons (joint account maintained by an FFI)</td>
                    <td className="border border-black p-2 align-top">Each holder of the account</td>
                  </tr>
                  <tr>
                    <td className="border border-black p-2 align-top">4. Custodial account of a minor (Uniform Gift to Minors Act)</td>
                    <td className="border border-black p-2 align-top">The minor</td>
                  </tr>
                   <tr>
                    <td className="border border-black p-2 align-top">5. a. The usual revocable savings trust (grantor is also trustee) <br/> b. So-called trust account that is not a legal or valid trust under state law</td>
                    <td className="border border-black p-2 align-top">The grantor-trustee¹</td>
                  </tr>
                   <tr>
                    <td className="border border-black p-2 align-top">6. Sole proprietorship or disregarded entity owned by an individual</td>
                    <td className="border border-black p-2 align-top">The actual owner¹</td>
                  </tr>
                   <tr>
                    <td className="border border-black p-2 align-top">7. Grantor trust filing under Optional Form 1099 Filing Method 1 (see Regulations section 1.671-4(b)(2)(i)(A))</td>
                    <td className="border border-black p-2 align-top">The grantor¹</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="space-y-4">
            ...
            <table className="w-full mt-0 border-collapse border border-black table-fixed text-[11px] leading-normal">
              <thead className="bg-gray-50">
                <tr>
                  <th className="border border-black p-2 text-left font-bold align-top w-1/2">For this type of account:</th>
                  <th className="border border-black p-2 text-left font-bold align-top w-1/2">Give name and EIN of:</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-black p-2 align-top">8. Disregarded entity not owned by an individual</td>
                  <td className="border border-black p-2 align-top">The owner</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">9. A valid trust, estate, or pension trust</td>
                  <td className="border border-black p-2 align-top">Legal entity²</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">10. Corporation or LLC electing corporate status on Form 8832 or Form 2553</td>
                  <td className="border border-black p-2 align-top">The corporation</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">11. Association, club, religious, charitable, educational, or other tax-exempt organization</td>
                  <td className="border border-black p-2 align-top">The organization</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">12. Partnership or multi-member LLC</td>
                  <td className="border border-black p-2 align-top">The partnership</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">13. A broker or nominee</td>
                  <td className="border border-black p-2 align-top">The broker or nominee</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">14. Account with the Department of Agriculture in the name of a public entity (such as a state or local government, school district, or prison) that receives agricultural program payments</td>
                  <td className="border border-black p-2 align-top">The public entity</td>
                </tr>
                <tr>
                  <td className="border border-black p-2 align-top">15. Grantor trust filing under Form 1041 or under the Optional Form 1099 Filing Method 2 (see Regulations section 1.671-4(b)(2)(i)(B))</td>
                  <td className="border border-black p-2 align-top">The trust</td>
                </tr>
              </tbody>
            </table>
            {/* Table Footnotes */}
            <div className="space-y-1 text-xs">
              ...
              <p>
                *<strong className="font-bold">Note:</strong> The grantor also must provide a Form W-9 to the trustee of the trust.
              </p>
              <p>
                <strong className="font-bold">Note:</strong> For more information on optional filing methods for grantor trusts, see the Instructions for Form 1041.
              </p>
            </div>
            {/* Secure Your Tax Records */}
            <div className="space-y-2 pt-2">
              <h2 className="text-sm font-bold">Secure Your Tax Records From Identity Theft</h2>
              <p>
                Identity theft occurs when someone uses your personal information
                such as your name, SSN, or other identifying information, without your
                permission, to commit fraud or other crimes. An identity thief may use
                your SSN to get a job or may file a tax return using your SSN to receive a
                refund.
              </p>
              ...
              <p>
                ...
                Identity Theft Hotline at 1-800-908-4490 or submit Form 14039.
              </p>
              <p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p>
                ...
                have not been resolved through normal IRS channels, may contact the
            ...
            <div className="space-y-2">
              <strong className="font-bold block text-sm">Protect yourself from suspicious emails or phishing schemes.</strong>
              <p>
                Identity theft is the creation or use of email and websites designed to
                mimic legitimate business emails and websites. The most common act
                is to send an email to a user, falsely claiming to be an established
                legitimate enterprise in an attempt to scare the user into surrendering
                private information that can be used for identity theft.
              </p>
              <p>
                The IRS does not initiate contacts with taxpayers via emails. Also, the
                IRS does not request personal detailed information through email or ask
                a taxpayer for his/her financial or personal PIN from emails. Do not
                give out financial information, for their credit card, bank, or other
                financial accounts.
              </p>
              <p>
                If you receive an unsolicited email claiming to be from the IRS,
                forward this message to <em className="italic">phishing@irs.gov</em>. You may also report misuse
                of the IRS name, logo, or other IRS property to the Treasury Inspector
                General for Tax Administration (TIGTA) at 800-366-4484. You can
                forward suspicious emails to the Federal Trade Commission at
                <em className="italic">www.ftc.gov/complaint</em>. Or you can write to FTC Consumer Response Center, 600 Pennsylvania Ave. NW, Washington, DC 20580.
              </p>
              <p>
                If you are a victim of identity theft, see <em className="italic">www.identityTheft.gov</em>,
                and Pub. 5027.
              </p>
              <p>
                Go to <em className="italic">www.irs.gov/identityTheft</em> to learn more about identity theft and
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                IRS uses the TINs for identification purposes and to help to
                facilitate the matching of information returns with the appropriate tax
                returns. The IRS may also give this information to the Department of
                Justice for civil and criminal litigation and to cities, states, the
                District of Columbia, and U.S. commonwealths and territories for use in
...
export default function W9Form() {
    ...
    try {
      ...
      if (response.data?.w9Form) {
        ...
        setFormData({
          ...
          signatureDate: data.signatureDate ? new Date(data.signatureDate).toISOString().split('T')[0] : "",
        });
        // Check if form has meaningful data
        const hasData = data.name || data.businessName || data.taxClassification || 
                        data.address || data.city || data.signature ||
  ...
  return (
    ...
    >
      ...
      <form>
        <div className="w9-form-container" style={{ border: "3px solid black" }}>
          {/* Top Header Row */}
          <div className="flex flex-col sm:flex-row" style={{ borderBottom: "3px solid black" }}>
            {/* Form W-9 Section */}
            <div
            ...
            <div
              ...
              style={{ padding: "10px 16px", fontFamily: "Arial, sans-serif" }}
            >
              <div
          ...
          >
            <span style={{ fontWeight: "bold" }}>Before you begin.</span> For
            guidance related to the purpose of Form W-9, see{" "}
            <span style={{ fontStyle: "italic" }}>Purpose of Form</span>, below.
          </div>
          ...
          <div style={{ padding: "8px" }}>
            ...
            <div style={{ marginBottom: "6px" }}>
              ...
              >
                <span style={{ fontWeight: "bold" }}>1</span>&nbsp;&nbsp;Name of
                entity/individual. An entry is required. (For a sole proprietor
                or disregarded entity, enter the owner's name on line 1, and
                enter the business/disregarded entity's name on line 2.))
              </div>
              <div style={{ borderBottom: "1px solid black", height: "22px" }}>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row" style={{ flexGrow: 1 }}>
                  ...
                  >
                    ...
                    <div style={{ padding: "6px 8px" }}>
                      ...
                      >
                        ...
                        <span style={{ fontWeight: "bold" }}>only one</span> of
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <span>
                            LLC. Enter the tax classification (C = C corp, S = S
                            corp, P = Partnership) . . . .
                          </span>
                        </label>
                        <input
                      ...
                      >
                        <span style={{ fontWeight: "bold" }}>Note:</span> Check
                        the "LLC" box above and, in the entity space, enter the
                        appropriate code (C, S, or P) for the tax classification
                        of the LLC, unless it is a disregarded entity. A
                        disregarded entity should instead check the appropriate
                      ...
                      >
                        ...
                        <input
                          ...
                          disabled={formData.taxClassification !== "other"}
                        />
                      </div>
                      ...
                      >
                        <span>
                          ...
                          &nbsp;&nbsp;If on line 3a you checked "Partnership" or
                          ...
                          have an ownership interest, check this box if you have
                          any foreign partners, owners, or beneficiaries. See
                          instructions&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.&nbsp;&nbsp;.
                        </span>
                        <input
                          type="checkbox"
              ...
              <div className="flex flex-col sm:flex-row" style={{ borderTop: "1px solid black" }}>
                <div
                  className="hidden sm:flex"
                  style={{
                    width: "55px",
                ...
                <div style={{ flex: 1, padding: "6px 8px" }}>
                  ...
                  <div
                    style={{ borderBottom: "1px solid black", height: "22px" }}
                  >
                    <input
                      type="text"
                      name="accountNumbers"
            ...
            {/* Part I Content */}
            <div className="flex flex-col md:flex-row" style={{ marginBottom: "10px", gap: "10px" }}>
              {/* Part I Text - NARROWER (flex: 1) */}
              <div className="flex-1" style={{ fontSize: "10pt", lineHeight: "1.25" }}>
                <p style={{ marginBottom: "6px" }}>
                  ...
                  <span style={{ fontStyle: "italic" }}>How to get a TIN</span>,
                  later.
                </p>
              ...
              <div className="w-full md:w-[300px]" style={{ fontFamily: "Arial, sans-serif" }}>
            ...
            >
              ...
              <div className="w-full sm:w-[175px] sm:pl-[10px] pl-0" style={{ paddingLeft: "10px" }}>
                <div
                  style={{
                    fontWeight: "bold",
                    fontSize: "9.5pt",
      ...
      >
        ...
        <div>
          Form <span style={{ fontWeight: "bold" }}>W-9</span> (Rev. 3-2024)
        </div>
      </div>
    </div>
