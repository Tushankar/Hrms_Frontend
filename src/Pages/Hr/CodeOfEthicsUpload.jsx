  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${baseURL}/onboarding/hr-upload-code-of-ethics-template`,
        formData,
        {
      ...
      if (response.data) {
        toast.success("Code of Ethics template uploaded successfully!");
        setFile(null);
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">
              Upload Code of Ethics Template
            </h1>
            <p className="text-gray-600">
              Upload a PDF template that employees will download, sign, and upload back
            </p>
          </div>
...
export default CodeOfEthicsUpload;
