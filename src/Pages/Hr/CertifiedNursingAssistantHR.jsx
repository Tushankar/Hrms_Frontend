...
const CertifiedNursingAssistantHR = () => {
  ...
  const fetchEmployeeSubmission = async () => {
    try {
      ...
      const formData = response.data?.data?.forms?.jobDescriptionCNA;
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${baseURL}/onboarding/hr-upload-cna-job-description-template`,
        formData,
        {
  ...
  const handleClearSubmission = async () => {
    ...
    try {
      await axios.delete(
        `${baseURL}/onboarding/hr-clear-cna-submission/${employeeId}`,
        { withCredentials: true }
      );
          ...
          {loading ? (
            ...
            <div className="space-y-8">
              ...
              <div className="text-center pt-4">
                <button
                  onClick={() => navigate("/hr/cna-job-description-submissions")}
...
export default CertifiedNursingAssistantHR;
