...
const RegisteredNurseHR = () => {
  ...
  const fetchEmployeeSubmission = async () => {
    try {
      ...
      const formData = response.data?.data?.forms?.jobDescriptionRN;
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${baseURL}/onboarding/hr-upload-rn-job-description-template`,
        formData,
        {
  ...
  const handleClearSubmission = async () => {
    ...
    try {
      await axios.delete(
        `${baseURL}/onboarding/hr-clear-rn-submission/${employeeId}`,
        { withCredentials: true }
      );
          ...
          {loading ? (
            ...
            <div className="space-y-8">
              ...
              <div className="text-center pt-4">
                <button
                  onClick={() => navigate("/hr/rn-job-description-submissions")}
...
export default RegisteredNurseHR;
